// frontend/src/utils/streaming.js
...
const initializeStreaming = (
  ...
  const startStreaming = () => {
    if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
      const errorMsg =
        "Media devices not supported or unavailable. Please ensure camera/mic permissions are granted and use HTTPS.";
      console.error("Streamer media error:", errorMsg);
